...
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= spotify
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/conradludgate/terraform-provider-spotify/releases/download/v${TERRAFORM_PROVIDER_VERSION}
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-spotify_${TERRAFORM_PROVIDER_VERSION}
